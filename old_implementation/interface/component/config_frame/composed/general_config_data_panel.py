...
from tkinter import *
from old_implementation.interface.component.config_frame.simple.button_box import ButtonBox
from config_parser import CustomConfigParser
from old_implementation.interface.component.input_frame.simple.option_menu import SimpleOptionMenu
from old_implementation.interface.component.config_frame.simple.single_button_box import SingleButtonBox
import gettext
from lib.providers.resource_providers.summary_provider import SummaryResourceProvider
from lib.providers.resource_providers.cover_provider import CoverResourceProvider
try:
...
class GeneralConfigDataPanel(Frame):
    ...
    def clear_cache(self):
        try:
            description_downloader = SummaryResourceProvider()
