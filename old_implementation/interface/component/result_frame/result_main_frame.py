...
from old_implementation.interface.component.result_frame.composed.info_panel import InfoPanel
from old_implementation.interface.component.result_frame.composed.result_panel import ResultPanel
