...
class MetroTileBar:
    def __init__(self, root):
        ...
        self.close_img = PhotoImage(file='./interface/metro_tile_bar/static/image/close.png')
        self.close_mouse = PhotoImage(file='./interface/metro_tile_bar/static/image/close_mouse.png')
        self.minimize_img = PhotoImage(file='./interface/metro_tile_bar/static/image/minimize.png')
        self.minimize_mouse = PhotoImage(file='./interface/metro_tile_bar/static/image/minimize_mouse.png')
        self.restore = PhotoImage(file='./interface/metro_tile_bar/static/image/restore.png')
        self.restore_mouse = PhotoImage(file='./interface/metro_tile_bar/static/image/restore_mouse.png')
        self.maximize = PhotoImage(file='./interface/metro_tile_bar/static/image/maximize.png')
        self.maximize_mouse = PhotoImage(file='./interface/metro_tile_bar/static/image/maximize_mouse.png')
