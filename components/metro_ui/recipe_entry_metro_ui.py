...
class Metro_Button(Button):
    def __init__(self, master, text, background, ID=None, foreground="white",
        ...
        Button.__init__(self, master, ID=ID, text=text,
...
class Metro_Entry(Frame):
    ...
    def __init__(self, master, width=None, placeholder=None, placeholder_font=None,
                 placeholder_color="grey", highlightthickness=1, state=NORMAL, font=None, ID=None,
                 autocomplete_list=None, default_message=None, *args, **kwargs):

        self._frame = Frame.__init__(self, master, ID=ID, bd=0, background=Metro_Entry.BACKGROUND,
        ...
        self._entry = Entry(self, background=Metro_Entry.BACKGROUND,
                            disabledbackground=Metro_Entry.DISABLED_BACKGROUND,
                            disabledforeground=Metro_Entry.DISABLED_FOREGROUND, bd=0,
    ...
    def _on_focusin(self, event):
        if self._highlightthickness == 0:
            self.configure(highlightbackground=Metro_Entry.BORDER_COLOR,
                           highlightcolor=Metro_Entry.BORDER_COLOR,
                           highlightthickness=Metro_Entry.BORDER_WIDTH)
        else:
            self.configure(highlightbackground=Metro_Entry.ACTIVE_BORDERCOLOR,
                           highlightcolor=Metro_Entry.ACTIVE_BORDERCOLOR,
            ...
            if words:
                ...
                if not self.listbox_up:
                    self.listbox = Listbox(self._frame, width=71, height=self.listboxLength, relief=FLAT,
                                           highlightbackground=Metro_Entry.BORDER_COLOR,
                                           highlightcolor=Metro_Entry.BORDER_COLOR,
                                           highlightthickness=Metro_Entry.BORDER_WIDTH)
...
from components.metro_ui.recipe_autocomplete_v2 import AutocompleteEntry
...
class Search_Box(Frame):
    def __init__(self, master, button_text="Search", button_ipadx=16, button_background='#3C3F41',
                 ...
                 entry_width=60, entry_font=None, command=None, ID=None):

        Frame.__init__(self, master, ID=ID)
        
        self._command = command

        self.entry = Metro_Entry(self, width=entry_width, placeholder=placeholder, placeholder_font=placeholder_font,
                                 placeholder_color=placeholder_color, highlightthickness=entry_highlightthickness,
                                 matchesFunction=matches, autocomplete_list=autocompleteList, listboxLength=6)
        ...
        self.button = Metro_Button(self, text=button_text, background=button_background, foreground=button_foreground,
                                   font=button_font, command=self._execute_command, padx=button_ipadx)
