from tkinter import *
from old_implementation.interface.component.result_frame.simple.poster_box import SimplePosterBox
from old_implementation.interface.component.result_frame.simple.info_box import SimpleInfoBox
