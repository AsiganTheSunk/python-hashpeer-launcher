from tkinter import *
from component_filters.constants import DEFAULT_BACKGROUND_COLOR, DEFAULT_MOUSE_OVER_TAB, DEFAULT_FONT_STYLE, \
    DEFAULT_FONT_SIZE, DEFAULT_SELECTED_UNDER_SCORE_TAB, DEFAULT_SELECTED_TREE_VIEW, DEFAULT_DARK_BACKGROUND_COLOR,\
    DEFAULT_TEXT_COLOR, DEFAULT_DIMMED_TEXT_COLOR
