from interface.component_filters.frame_multi_option_menu import create_menu_selector
from interface.component_filters.frame_menu_options import FrameOptionMenu
from typing import Callable
from tkinter import *
from interface.component_filters.constants import DEFAULT_FILTER_LABELS, CATEGORY_LABEL, DEFAULT_FONT_SIZE, DEFAULT_FONT_STYLE, \
...
from interface.component_filters.entry_filter_list import EntryFilterList
from interface.components.metro_ui.metro_search_entry_containter import MetroSearchEntryContainer
...
class CategoryFilterOptionMenu(Frame):
    def __init__(self, root):
        ...
        self.add_filter_button = MetroButtonContainer(self.category_root, text='  +  ', background=DEFAULT_BACKGROUND_COLOR)
        ...
        self.search_box = MetroSearchEntryContainer(self.search_input_root, command=self.compose_entry_data, placeholder="Search")
