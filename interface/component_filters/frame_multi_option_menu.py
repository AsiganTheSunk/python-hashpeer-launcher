...
from interface.component_filters.constants import DEFAULT_FILTER_LABELS, DEFAULT_BACKGROUND_COLOR, CATEGORY_LABEL
...
class FrameMultiOptionMenu(object):
    ...
    def show(self, root_value_selection):
        ...
        # disabled: until opt_menu_filter_types selects something
        self.add_filter_button = MetroButtonContainer(self.frame_select, text='  Add Filter  ', background=DEFAULT_BACKGROUND_COLOR, command=self.add_filter_label)
        ...
        self.cancel_filter_button = MetroButtonContainer(self.frame_select, text='    Cancel    ',
